...
TARGET_MODULES = [
    ...
    Path("src/gui_tools/erd_designer/build.py"),
    Path("src/gui_tools/erd_designer/helpers.py"),
    Path("src/gui_tools/erd_designer/authoring_sync.py"),
    Path("src/gui_tools/erd_designer/authoring_actions.py"),
    Path("src/gui_tools/erd_designer/io_export.py"),
    Path("src/gui_tools/erd_designer/rendering.py"),
    Path("src/gui_tools/erd_designer/dragging.py"),
